...
$students = [];
$result = $pdo->query("SELECT * FROM students ORDER BY id ASC");
$students = $result->fetchAll();

$fetchedStudent = null;
if (!empty($_GET['fetch_id'])) {
    $fid = intval($_GET['fetch_id']);
    $fstmt = $pdo->prepare("SELECT * FROM students WHERE id=?");
    $fstmt->execute([$fid]);
    $fetchedStudent = $fstmt->fetch();
...
<body>
    <nav class="navbar">
        <div class="brand-container">
            <img src="../images/KSU_Logo.png" id="logo" onclick="logoClick()" style="cursor: pointer;" alt="Logo">
    ...
    <section id="create" class="content">
        ...
        <form action="../includes/insert.php" method="POST">
            ...
            <div id="btncontainer">
                <button type="button" id="clrbtn" class="btns" onclick="clearFields(this.closest('form'))">Clear Fields</button>
